...
class Laptop
{
    ...
    public string Model
    {
        ...
        set
        {
            ...
            {
                throw new ArgumentNullException("model", "Model cannot be a null or empty string");
            }
    ...
    public decimal Price
    {
        ...
        set
        {
            if (value < 0.0m)
            {
                throw new ArgumentOutOfRangeException("price", "Price cannot be a negative number or string");
            }
    ...
    public Laptop(string model, decimal price, string manufacturer, string processor, string ram, 
            string gpu, string hdd, Battery laptopBattery) 
    ...
    public Laptop(string model, decimal price, string manufacturer, string processor, string ram, 
            string gpu, string hdd, Battery laptopBattery, string display)
